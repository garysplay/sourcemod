...
DWORD InitImGui()
{
	...
	::RegisterClassEx(&wc);
	SetWindowLongPtr((HWND)GetForegroundWindow(), GWLP_WNDPROC, (LONG)WndProc);
	...
	ImGui_ImplDX9_Init(GetForegroundWindow(),g_pd3dDevice);
...
// Purpose: Job wrapper
//-------------------------
static unsigned long long PanelJobWrapperFn( void *pvContext )
{
