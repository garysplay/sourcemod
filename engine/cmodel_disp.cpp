...
//		maxs += Vector( 0.5, 0.5, 0.5 );
	...
	void WriteLeafList( int*pLeafList )
	{
...
void CM_DispTreeLeafnum( CCollisionBSPData *pBSPData )
{
	...
	pBSPData->map_dispList.Attach( count, (int*)Hunk_Alloc( sizeof(int) * count, false ) );
