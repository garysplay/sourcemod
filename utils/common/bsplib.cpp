...
DEFINE_FIELD(m_PropType, FIELD_INTEGER),
DEFINE_FIELD(m_FirstLeaf, FIELD_INTEGER),
DEFINE_FIELD(m_LeafCount, FIELD_INTEGER),
...
//int InitWorldLights()
//{
//	dworldlightsLDR = new dworldlight_t*[1];
//	V_memset(dworldlightsLDR, 0,  sizeof(dworldlight_t*));
//	dworldlightsHDR = new dworldlight_t*[1];
//	V_memset(dworldlightsHDR, 0,  sizeof(dworldlight_t*));
//
//	return 0;
//}
//
...
//		ParseEntities ();
	...
	totalmemory += ArrayUsage( "HDR worldlights",	dworldlights.Count(), 0, sizeof(dworldlights[0]));
